...
json = keycloak/5.0.json keycloak/6.0.json keycloak/7.0.json keycloak/8.0.json keycloak/9.0.json keycloak/sso-6.json keycloak/sso-7.3.json

html = keycloak/5.0.html keycloak/6.0.html keycloak/7.0.html keycloak/8.0.html keycloak/9.0.html keycloak/sso-6.html keycloak/sso-7.3.html
...
keycloak/sso-7.3.html:
	curl https://access.redhat.com/webassets/avalon/d/red-hat-single-sign-on/version-7.3/restapi/ > $@
